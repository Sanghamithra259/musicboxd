                ...
                <div className="flex-1 flex flex-col gap-16">
                    ...
                    {session ? (
                        <div className="flex gap-4">
                            <button className="flex-1 bg-accent text-bg font-bold uppercase font-mono tracking-widest py-3 rounded hover:bg-white transition-colors text-sm">
                                Log & Rate
                            </button>
                            <button className="flex-1 bg-surface border border-border text-text font-bold uppercase font-mono tracking-widest py-3 rounded hover:bg-surface2 transition-colors text-sm">
                                Add to List
                            </button>
                            <button className="bg-surface border border-border text-text font-bold font-mono py-3 px-4 rounded hover:bg-surface2 transition-colors flex items-center justify-center">
                        ...
                        <div className="w-full bg-surface2 border border-border p-6 rounded text-center flex flex-col gap-3 items-center">
                            <p className="font-sans text-textMuted text-sm">
                                Sign in to log, rate, or review <span className="text-white italic font-serif">{album.name}</span>.
                            </p>
